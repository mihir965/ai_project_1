...
def time_lapse_fn_bot2(grid, q, n, frames, src, dest, fire_init, seed_value):
    ...
    log_data = {
        ...
        'steps': 0,
        'result': '',
        'final_frame': f'C:/Users/shaiv/Downloads/ai_project_1-main/final_frames/{run_id}.png',
    ...
    save_final_frame(frames[-1], filename=f'C:/Users/shaiv/Downloads/ai_project_1-main/final_frames/{run_id}.png')
