...
random.seed(seed_value)
np.random.seed(seed_value)
time_lapse_fn_bot_1(grid.copy(), q, n, frames_bot1, bot_pos, button_pos, fire_init, seed_value, trial=0)

print("Bot 2")
random.seed(seed_value)
np.random.seed(seed_value)
time_lapse_fn_bot2(grid.copy(), q, n, frames_bot2, bot_pos, button_pos, fire_init, seed_value, trial=0)
...
# random.seed(seed_value)
# np.random.seed(seed_value)
# time_lapse_fn_bot4_prob_safe(grid.copy(), q, n, frames_bot4, bot_pos, button_pos, fire_init, seed_value)